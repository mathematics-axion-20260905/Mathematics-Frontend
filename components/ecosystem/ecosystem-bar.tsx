  ...
  return (
    <div className="ax-ecosystem-bar">
      <div className="ax-ecosystem-bar-inner">
        <a href={getEcosystemHref("science", currentApp, activeProjectId)} className="ax-ecosystem-brand">
          {ECOSYSTEM_NAME}
        </a>
        ...
        <a href={getEcosystemHref("science", currentApp, activeProjectId)} className="ax-ecosystem-project">
          <span className="ax-ecosystem-project-label">{labels.project}</span>
          <span className="ax-ecosystem-project-value">{activeProjectTitle || (activeProjectId ? labels.active : labels.local)}</span>
        </a>
        <LanguageSwitcher />
      </div>
    </div>
