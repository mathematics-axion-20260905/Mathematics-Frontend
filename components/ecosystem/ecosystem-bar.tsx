    ...
    <div className="ax-ecosystem-bar">
      <div className="ax-ecosystem-bar-inner">
        ...
        <a href={getEcosystemHref("science", currentApp, activeProjectId)} className="ax-ecosystem-project">
          <span className="ax-ecosystem-project-label">Project</span>
          <span className="ax-ecosystem-project-value">{activeProjectTitle || (activeProjectId ? "Active project" : "Local workspace")}</span>
        </a>
      </div>
    </div>
  );
